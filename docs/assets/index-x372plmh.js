  ...
  "<stdin>"(exports, module) {
    (async () => {
      ...
      const oe = {}, Kt = [], it = () => {
        ...
        const n = e.indexOf(t);
        n > -1 && e.splice(n, 1);
      }, Rl = Object.prototype.hasOwnProperty, ee = (e, t) => Rl.call(e, t), z = Array.isArray, Gt = (e) => Ln(e) === "[object Map]", yo = (e) => Ln(e) === "[object Set]", qi = (e) => Ln(e) === "[object Date]", W = (e) => typeof e == "function", fe = (e) => typeof e == "string", Ge = (e) => typeof e == "symbol", ae = (e) => e !== null && typeof e == "object", Us = (e) => (ae(e) || W(e)) && W(e.then) && W(e.catch), Ws = Object.prototype.toString, Ln = (e) => Ws.call(e), Ml = (e) => Ln(e).slice(8, -1), Ks = (e) => Ln(e) === "[object Object]", vi = (e) => fe(e) && e !== "NaN" && e[0] !== "-" && "" + parseInt(e, 10) === e, pn = gi(",key,ref,ref_for,ref_key,onVnodeBeforeMount,onVnodeMounted,onVnodeBeforeUpdate,onVnodeUpdated,onVnodeBeforeUnmount,onVnodeUnmounted"), xo = (e) => {
        const t = /* @__PURE__ */ Object.create(null);
      ...
      function Fl(e) {
        ...
        return t && !fe(t) && (e.class = Ve(t)), n && (e.style = Pt(n)), e;
      }
      ...
      function en(e, t) {
        ...
        if (n = z(e), o = z(t), n || o) return n && o ? jl(e, t) : false;
      ...
      const Xs = (e) => !!(e && e.__v_isRef === true), Me = (e) => fe(e) ? e : e == null ? "" : z(e) || ae(e) && (e.toString === Ws || !W(e.toString)) ? Xs(e) ? Me(e.value) : JSON.stringify(e, Js, 2) : String(e), Js = (e, t) => Xs(t) ? Js(e, t.value) : Gt(t) ? {
        [`Map(${t.size})`]: [
          ...t.entries()
      ...
      } : Ge(t) ? qo(t) : ae(t) && !z(t) && !Ks(t) ? String(t) : t, qo = (e, t = "") => {
        var n;
      ...
      function dt(e, t, n, o, i, s) {
        ...
        if (bi(), t === "clear") r.forEach(l);
          ...
          const a = z(e), f = a && vi(n);
          if (a && n === "length") {
            const c = Number(o);
            r.forEach((d, h) => {
              (h === "length" || h === Sn || !Ge(h) && h >= c) && l(d);
            });
          } else switch ((n !== void 0 || r.has(void 0)) && l(r.get(n)), f && l(r.get(Sn)), t) {
            case "add":
              a ? f && l(r.get("length")) : (l(r.get(Bt)), Gt(e) && l(r.get(ni)));
              break;
            case "delete":
      ...
      const Yl = {
        ...
        concat(...e) {
          return Vt(this).concat(...e.map((t) => z(t) ? Vt(t) : t));
        },
        entries() {
      ...
      class ar extends lr {
        ...
        set(t, n, o, i) {
          ...
          if (!this._isShallow) {
            const a = Rt(s);
            if (!ze(o) && !Rt(o) && (s = Z(s), o = Z(o)), !z(t) && ve(s) && !ve(o)) return a ? false : (s.value = o, true);
          }
          const r = z(t) && vi(n) ? Number(n) < t.length : ee(t, n), l = Reflect.set(t, n, o, ve(t) ? t : i);
        ...
        ownKeys(t) {
          return ye(t, "iterate", z(t) ? "length" : Bt), Reflect.ownKeys(t);
        }
      }
      class Zl extends lr {
        constructor(t = false) {
      ...
      function oa(e, t, n) {
        return function(...o) {
          const i = this.__v_raw, s = Z(i), r = Gt(s), l = e === "entries" || e === Symbol.iterator && r, a = e === "keys" && r, f = i[e](...o), c = n ? oi : t ? so : me;
      ...
      function ia(e, t) {
        const n = {
          get(i) {
            ...
            const { has: a } = qn(r), f = t ? oi : e ? so : me;
            if (a.call(r, i)) return f(s.get(i));
          ...
          forEach(i, s) {
            const r = this, l = r.__v_raw, a = Z(l), f = t ? oi : e ? so : me;
            return !e && ye(a, "iterate", Bt), l.forEach((c, d) => i.call(s, f(c), f(d), r));
          }
        };
        return Se(n, e ? {
          add: Vn("add"),
          ...
          set(i, s) {
            ...
            let f = l.call(r, i);
            f || (i = Z(i), f = l.call(r, i));
            const c = a.call(r, i);
            return r.set(i, s), f ? Ct(s, c) && dt(r, "set", i, s) : dt(r, "add", i, s), this;
          },
          delete(i) {
            ...
            const f = s.delete(i);
            return a && dt(s, "delete", i, void 0), f;
          },
          clear() {
      ...
      function xa(e, t, n = oe) {
        const { immediate: o, deep: i, once: s, scheduler: r, augmentJob: l, call: a } = n, f = (y) => i ? y : ze(y) || i === false || i === 0 ? pt(y, 1) : pt(y);
        let c, d, h, _, w = false, v = false;
        if (ve(e) ? (d = () => e.value, w = ze(e)) : Yt(e) ? (d = () => f(e), w = true) : z(e) ? (v = true, w = e.some((y) => Yt(y) || ze(y)), d = () => e.map((y) => {
        ...
        const D = (y) => {
          if (!(!(c.flags & 1) || !c.dirty && !y)) if (t) {
            const R = c.run();
            if (i || w || (v ? R.some((J, F) => Ct(J, C[F])) : Ct(R, C))) {
              h && h();
              const J = Ft;
              Ft = c;
              try {
        ...
        }, t ? o ? D(true) : C = c.run() : r ? r(D.bind(null, true), true) : c.run(), P.pause = c.pause.bind(c), P.resume = c.resume.bind(c), P.stop = P, P;
      }
      function pt(e, t = 1 / 0, n) {
        if (t <= 0 || !ae(e) || e.__v_skip || (n = n || /* @__PURE__ */ new Set(), n.has(e))) return e;
        if (n.add(e), t--, ve(e)) pt(e.value, t, n);
        else if (z(e)) for (let o = 0; o < e.length; o++) pt(e[o], t, n);
      ...
      function Ta(e) {
        z(e) ? Xt.push(...e) : St && e.id === -1 ? St.splice(Wt + 1, 0, e) : e.flags & 1 || (Xt.push(e), e.flags |= 1), mr();
      }
      ...
      function co(e, t, n, o, i = false) {
        if (z(e)) {
          e.forEach((w, v) => co(w, t && (z(t) ? t[v] : t), n, o, i));
          return;
        }
        if (Jt(o) && !i) {
        ...
        const s = o.shapeFlag & 4 ? Mo(o.component) : o.el, r = i ? null : s, { i: l, r: a } = e, f = t && t.r, c = l.refs === oe ? l.refs = {} : l.refs, d = l.setupState, h = Z(d), _ = d === oe ? () => false : (w) => ee(h, w);
        if (f != null && f !== a && (fe(f) ? (c[f] = null, _(f) && (d[f] = null)) : ve(f) && (f.value = null)), W(a)) kn(a, l, 12, [
          r,
          c
        ]);
        else {
          ...
          if (w || v) {
            const m = () => {
              if (e.f) {
                const P = w ? _(a) ? d[a] : c[a] : a.value;
                i ? z(P) && wi(P, s) : z(P) ? P.includes(s) || P.push(s) : w ? (c[a] = [
                  s
                ], _(a) && (d[a] = c[a])) : (a.value = [
                  s
                ], e.k && (c[e.k] = a.value));
      ...
      function At(e, t, n, o) {
        ...
        if (r || fe(e)) {
          const l = r && Yt(e);
          let a = false, f = false;
          l && (a = !ze(e), f = Rt(e), e = To(e)), i = new Array(e.length);
          for (let c = 0, d = e.length; c < d; c++) i[c] = t(a ? f ? so(me(e[c])) : me(e[c]) : e[c], c, void 0, s);
        ...
        get({ _: e }, t) {
          ...
          if (t[0] !== "$") {
            ...
            if (_ !== void 0) switch (_) {
              ...
              if ((f = e.propsOptions[0]) && ee(f, t)) return r[t] = 3, s[t];
      ...
      function Wa(e) {
        ...
        const { data: i, computed: s, methods: r, watch: l, provide: a, inject: f, created: c, beforeMount: d, mounted: h, beforeUpdate: _, updated: w, activated: v, deactivated: m, beforeDestroy: P, beforeUnmount: C, destroyed: D, unmounted: y, render: R, renderTracked: J, renderTriggered: F, errorCaptured: j, serverPrefetch: ne, expose: U, inheritAttrs: se, components: ge, directives: $e, filters: he } = t;
        if (f && Ka(f, o, null), r) for (const G in r) {
          const K = r[G];
          W(K) && (o[G] = K.bind(n));
        }
        if (i) {
        ...
        c && Xi(c, e, "c");
        function ce(G, K) {
          z(K) ? K.forEach((be) => G(be.bind(n))) : K && G(K.bind(n));
        }
        if (ce(Na, d), ce(Da, h), ce(La, _), ce(ka, w), ce(Ra, v), ce(Ma, m), ce(ja, j), ce(Ba, J), ce(za, F), ce(Ha, C), ce(Sr, y), ce(Fa, ne), z(U)) if (U.length) {
      ...
      function Xi(e, t, n) {
        lt(z(e) ? e.map((o) => o.bind(t.proxy)) : e.bind(t.proxy), t, n);
      }
      function Pr(e, t, n, o) {
        ...
        else if (ae(e)) if (z(e)) e.forEach((s) => Pr(s, t, n, o));
        else {
      ...
      function Ar(e) {
        ...
        let a;
        return l ? a = l : !i.length && !n && !o ? a = t : (a = {}, i.length && i.forEach((f) => uo(a, f, r, true)), uo(a, t, r)), ae(t) && s.set(t, a), a;
      }
      ...
      function Qa(e, t) {
        return function(o, i = null) {
          ...
          const f = s.app = {
            ...
            use(c, ...d) {
              return r.has(c) || (c && W(c.install) ? (r.add(c), c.install(f, ...d)) : W(c) && (r.add(c), c(f, ...d))), f;
            },
            mixin(c) {
              return s.mixins.includes(c) || s.mixins.push(c), f;
            },
            component(c, d) {
              return d ? (s.components[c] = d, f) : s.components[c];
            },
            directive(c, d) {
              return d ? (s.directives[c] = d, f) : s.directives[c];
            },
            mount(c, d, h) {
              if (!a) {
                const _ = f._ceVNode || pe(o, i);
                return _.appContext = s, h === true ? h = "svg" : h === false && (h = void 0), e(_, c, h), a = true, f._container = c, c.__vue_app__ = f, Mo(_.component);
              }
            },
            onUnmount(c) {
              l.push(c);
            ...
            unmount() {
              a && (lt(l, f._instance, 16), e(null, f._container), delete f._container.__vue_app__);
            },
            provide(c, d) {
              return s.provides[c] = d, f;
            },
            runWithContext(c) {
              const d = Qt;
              Qt = f;
        ...
        if ((o || r > 0) && !(r & 16)) {
          if (r & 8) {
            ...
            for (let d = 0; d < c.length; d++) {
              ...
              const _ = t[h];
              if (a) if (ee(s, h)) _ !== s[h] && (s[h] = _, f = true);
              else {
                const w = je(h);
                i[w] = li(a, l, w, _, e, false);
              }
              else _ !== s[h] && (s[h] = _, f = true);
            }
          }
        } else {
          Ir(e, t, i, s) && (f = true);
          ...
          if (s !== l) for (const d in s) (!t || !ee(t, d)) && (delete s[d], f = true);
        }
        f && dt(e.attrs, "set", "");
      }
      function Ir(e, t, n, o) {
        ...
        if (t) for (let a in t) {
          ...
          const f = t[a];
          let c;
          i && ee(i, c = je(a)) ? !s || !s.includes(c) ? n[c] = f : (l || (l = {}))[c] = f : Oo(e.emitsOptions, a) || (!(a in o) || f !== o[a]) && (o[a] = f, r = true);
        }
        if (s) {
          const a = Z(n), f = l || oe;
          for (let c = 0; c < s.length; c++) {
            const d = s[c];
            n[d] = li(i, a, d, f[d], e, !ee(f, d));
          }
        }
        return r;
      }
      ...
      function Nr(e, t, n = false) {
        ...
        if (z(s)) for (let c = 0; c < s.length; c++) {
          ...
          const d = je(c);
          if (Zi(d)) {
            const h = s[c], _ = r[d] = z(h) || W(h) ? {
              type: h
            } : Se({}, h), w = _.type;
            let v = false, m = true;
            if (z(w)) for (let P = 0; P < w.length; ++P) {
              const C = w[P], D = W(C) && C.name;
              if (D === "Boolean") {
                v = true;
                break;
      ...
      const Ri = (e) => e[0] === "_" || e === "$stable", Mi = (e) => z(e) ? e.map(nt) : [
        nt(e)
      ], oc = (e, t, n) => {
        if (t._n) return t;
      ...
      function lc(e, t) {
        const n = $o();
        n.__VUE__ = true;
        const { insert: o, remove: i, patchProp: s, createElement: r, createText: l, createComment: a, setText: f, setElementText: c, parentNode: d, nextSibling: h, setScopeId: _ = it, insertStaticContent: w } = e, v = (u, p, g, S = null, b = null, x = null, M = void 0, O = null, A = !!p.dynamicChildren) => {
          if (u === p) return;
          u && !cn(u, p) && (S = jn(u), Xe(u, b, x, true), u = null), p.patchFlag === -2 && (A = false, p.dynamicChildren = null);
          const { type: $, ref: k, shapeFlag: I } = p;
          switch ($) {
            case Ro:
              m(u, p, g, S);
              break;
            ...
            case Jn:
              ...
              break;
            case ie:
              ge(u, p, g, S, b, x, M, O, A);
              break;
            default:
              I & 1 ? R(u, p, g, S, b, x, M, O, A) : I & 6 ? $e(u, p, g, S, b, x, M, O, A) : (I & 64 || I & 128) && $.process(u, p, g, S, b, x, M, O, A, rn);
          }
          k != null && b && co(k, u && u.ref, x, p || u, !p);
        }, m = (u, p, g, S) => {
          if (u == null) o(p.el = l(p.children), g, S);
          else {
            const b = p.el = u.el;
            p.children !== u.children && f(b, p.children);
          }
        }, P = (u, p, g, S) => {
          u == null ? o(p.el = a(p.children || ""), g, S) : p.el = u.el;
        }, C = (u, p, g, S) => {
          [u.el, u.anchor] = w(u.children, p, g, S, u.el, u.anchor);
        }, D = ({ el: u, anchor: p }, g, S) => {
          let b;
          for (; u && u !== p; ) b = h(u), o(u, g, S), u = b;
          o(p, g, S);
        }, y = ({ el: u, anchor: p }) => {
          let g;
          for (; u && u !== p; ) g = h(u), i(u), u = g;
          i(p);
        }, R = (u, p, g, S, b, x, M, O, A) => {
          p.type === "svg" ? M = "svg" : p.type === "math" && (M = "mathml"), u == null ? J(p, g, S, b, x, M, O, A) : ne(u, p, b, x, M, O, A);
        }, J = (u, p, g, S, b, x, M, O) => {
          let A, $;
          const { props: k, shapeFlag: I, transition: L, dirs: q } = u;
          if (A = u.el = r(u.type, x, k && k.is, k), I & 8 ? c(A, u.children) : I & 16 && j(u.children, A, null, S, b, Go(u, x), M, O), q && Lt(u, null, S, "created"), F(A, u, u.scopeId, M, S), k) {
            for (const re in k) re !== "value" && !pn(re) && s(A, re, null, k[re], x, S);
            "value" in k && s(A, "value", null, k.value, x), ($ = k.onVnodeBeforeMount) && et($, S, u);
          }
          q && Lt(u, null, S, "beforeMount");
          const Y = ac(b, L);
          Y && L.beforeEnter(A), o(A, p, g), (($ = k && k.onVnodeMounted) || Y || q) && De(() => {
            $ && et($, S, u), Y && L.enter(A), q && Lt(u, null, S, "mounted");
          }, b);
        }, F = (u, p, g, S, b) => {
          if (g && _(u, g), S) for (let x = 0; x < S.length; x++) _(u, S[x]);
          if (b) {
            let x = b.subTree;
            if (p === x || qr(x.type) && (x.ssContent === p || x.ssFallback === p)) {
              const M = b.vnode;
              F(u, M, M.scopeId, M.slotScopeIds, b.parent);
            }
          }
        }, j = (u, p, g, S, b, x, M, O, A = 0) => {
          for (let $ = A; $ < u.length; $++) {
            const k = u[$] = O ? $t(u[$]) : nt(u[$]);
            v(null, k, p, g, S, b, x, M, O);
          }
        }, ne = (u, p, g, S, b, x, M) => {
          const O = p.el = u.el;
          let { patchFlag: A, dynamicChildren: $, dirs: k } = p;
          A |= u.patchFlag & 16;
          const I = u.props || oe, L = p.props || oe;
          let q;
          if (g && kt(g, false), (q = L.onVnodeBeforeUpdate) && et(q, g, p, u), k && Lt(p, u, g, "beforeUpdate"), g && kt(g, true), (I.innerHTML && L.innerHTML == null || I.textContent && L.textContent == null) && c(O, ""), $ ? U(u.dynamicChildren, $, O, g, S, Go(p, b), x) : M || K(u, p, O, null, g, S, Go(p, b), x, false), A > 0) {
            if (A & 16) se(O, I, L, g, b);
            else if (A & 2 && I.class !== L.class && s(O, "class", null, L.class, b), A & 4 && s(O, "style", I.style, L.style, b), A & 8) {
            ...
            A & 1 && u.children !== p.children && c(O, p.children);
          } else !M && $ == null && se(O, I, L, g, b);
          ((q = L.onVnodeUpdated) || k) && De(() => {
            q && et(q, g, p, u), k && Lt(p, u, g, "updated");
          }, S);
        }, U = (u, p, g, S, b, x, M) => {
          for (let O = 0; O < p.length; O++) {
            const A = u[O], $ = p[O], k = A.el && (A.type === ie || !cn(A, $) || A.shapeFlag & 198) ? d(A.el) : g;
            v(A, $, k, null, S, b, x, M, true);
          }
        }, se = (u, p, g, S, b) => {
          if (p !== g) {
            if (p !== oe) for (const x in p) !pn(x) && !(x in g) && s(u, x, p[x], null, b, S);
            for (const x in g) {
              if (pn(x)) continue;
              const M = g[x], O = p[x];
              M !== O && x !== "value" && s(u, x, O, M, b, S);
            }
            "value" in g && s(u, "value", p.value, g.value, b);
          }
        }, ge = (u, p, g, S, b, x, M, O, A) => {
          const $ = p.el = u ? u.el : l(""), k = p.anchor = u ? u.anchor : l("");
          let { patchFlag: I, dynamicChildren: L, slotScopeIds: q } = p;
          q && (O = O ? O.concat(q) : q), u == null ? (o($, g, S), o(k, g, S), j(p.children || [], g, k, b, x, M, O, A)) : I > 0 && I & 64 && L && u.dynamicChildren ? (U(u.dynamicChildren, L, g, b, x, M, O), (p.key != null || b && p === b.subTree) && Hr(u, p, true)) : K(u, p, g, k, b, x, M, O, A);
        }, $e = (u, p, g, S, b, x, M, O, A) => {
          p.slotScopeIds = O, u == null ? p.shapeFlag & 512 ? b.ctx.activate(p, g, S, M, A) : he(p, g, S, b, x, M, A) : Ye(u, p, A);
        }, he = (u, p, g, S, b, x, M) => {
          const O = u.component = Tc(u, S, b);
          if (yr(u) && (O.ctx.renderer = rn), Cc(O, false, M), O.asyncDep) {
            if (b && b.registerDep(O, ce, M), !u.el) {
              const A = O.subTree = pe(vt);
              P(null, A, p, g);
            }
          } else ce(O, u, p, g, b, x, M);
        }, Ye = (u, p, g) => {
          const S = p.component = u.component;
          if (mc(u, p, g)) if (S.asyncDep && !S.asyncResolved) {
            G(S, p, g);
            return;
          } else S.next = p, S.update();
          else p.el = u.el, S.vnode = p;
        }, ce = (u, p, g, S, b, x, M) => {
          const O = () => {
            if (u.isMounted) {
              let { next: I, bu: L, u: q, parent: Y, vnode: re } = u;
              {
                const Qe = Fr(u);
                if (Qe) {
                  I && (I.el = re.el, G(u, I, M)), Qe.asyncDep.then(() => {
                    u.isUnmounted || O();
                  });
                  return;
                }
              ...
              let te = I, Ie;
              kt(u, false), I ? (I.el = re.el, G(u, I, M)) : I = re, L && Yn(L), (Ie = I.props && I.props.onVnodeBeforeUpdate) && et(Ie, Y, I, re), kt(u, true);
              const Oe = ts(u), Je = u.subTree;
              u.subTree = Oe, v(Je, Oe, d(Je.el), jn(Je), u, b, x), I.el = Oe.el, te === null && wc(u, Oe.el), q && De(q, b), (Ie = I.props && I.props.onVnodeUpdated) && De(() => et(Ie, Y, I, re), b);
            } else {
              let I;
              const { el: L, props: q } = p, { bm: Y, m: re, parent: te, root: Ie, type: Oe } = u, Je = Jt(p);
              kt(u, false), Y && Yn(Y), !Je && (I = q && q.onVnodeBeforeMount) && et(I, te, p), kt(u, true);
              {
                Ie.ce && Ie.ce._injectChildStyle(Oe);
                const Qe = u.subTree = ts(u);
                v(null, Qe, g, S, u, b, x), p.el = Qe.el;
              }
              if (re && De(re, b), !Je && (I = q && q.onVnodeMounted)) {
                const Qe = p;
                De(() => et(I, te, Qe), b);
              }
              (p.shapeFlag & 256 || te && Jt(te.vnode) && te.vnode.shapeFlag & 256) && u.a && De(u.a, b), u.isMounted = true, p = g = S = null;
            }
          };
          u.scope.on();
          const A = u.effect = new Qs(O);
          u.scope.off();
          const $ = u.update = A.run.bind(A), k = u.job = A.runIfDirty.bind(A);
          k.i = u, k.id = u.uid, A.scheduler = () => Ei(k), kt(u, true), $();
        }, G = (u, p, g) => {
          p.component = u;
          const S = u.vnode.props;
          u.vnode = p, u.next = null, tc(u, p.props, S, g), sc(u, p.children, g), mt(), Ki(u), wt();
        }, K = (u, p, g, S, b, x, M, O, A = false) => {
          const $ = u && u.children, k = u ? u.shapeFlag : 0, I = p.children, { patchFlag: L, shapeFlag: q } = p;
          if (L > 0) {
            if (L & 128) {
              qt($, I, g, S, b, x, M, O, A);
              return;
          ...
          q & 8 ? (k & 16 && sn($, b, x), I !== $ && c(g, I)) : k & 16 ? q & 16 ? qt($, I, g, S, b, x, M, O, A) : sn($, b, x, true) : (k & 8 && c(g, ""), q & 16 && j(I, g, S, b, x, M, O, A));
        }, be = (u, p, g, S, b, x, M, O, A) => {
          u = u || Kt, p = p || Kt;
          const $ = u.length, k = p.length, I = Math.min($, k);
          let L;
          for (L = 0; L < I; L++) {
            const q = p[L] = A ? $t(p[L]) : nt(p[L]);
            v(u[L], q, g, null, b, x, M, O, A);
          }
          $ > k ? sn(u, b, x, true, false, I) : j(p, g, S, b, x, M, O, A, I);
        }, qt = (u, p, g, S, b, x, M, O, A) => {
          let $ = 0;
          const k = p.length;
          let I = u.length - 1, L = k - 1;
          for (; $ <= I && $ <= L; ) {
            const q = u[$], Y = p[$] = A ? $t(p[$]) : nt(p[$]);
            if (cn(q, Y)) v(q, Y, g, null, b, x, M, O, A);
            else break;
            $++;
          }
          for (; $ <= I && $ <= L; ) {
            const q = u[I], Y = p[L] = A ? $t(p[L]) : nt(p[L]);
            if (cn(q, Y)) v(q, Y, g, null, b, x, M, O, A);
            else break;
            I--, L--;
          }
          if ($ > I) {
            if ($ <= L) {
              const q = L + 1, Y = q < k ? p[q].el : S;
              for (; $ <= L; ) v(null, p[$] = A ? $t(p[$]) : nt(p[$]), g, Y, b, x, M, O, A), $++;
            }
          } else if ($ > L) for (; $ <= I; ) Xe(u[$], b, x, true), $++;
          else {
            const q = $, Y = $, re = /* @__PURE__ */ new Map();
            for ($ = Y; $ <= L; $++) {
              const Ne = p[$] = A ? $t(p[$]) : nt(p[$]);
              Ne.key != null && re.set(Ne.key, $);
            }
            let te, Ie = 0;
            const Oe = L - Y + 1;
            let Je = false, Qe = 0;
            ...
            for ($ = q; $ <= I; $++) {
              ...
              Ze === void 0 ? Xe(Ne, b, x, true) : (ln[Ze - Y] = $ + 1, Ze >= Qe ? Qe = Ze : Je = true, v(Ne, p[Ze], g, null, b, x, M, O, A), Ie++);
            }
            const Bi = Je ? cc(ln) : Kt;
            for (te = Bi.length - 1, $ = Oe - 1; $ >= 0; $--) {
              const Ne = Y + $, Ze = p[Ne], ji = Ne + 1 < k ? p[Ne + 1].el : S;
              ln[$] === 0 ? v(null, Ze, g, ji, b, x, M, O, A) : Je && (te < 0 || $ !== Bi[te] ? Dt(Ze, g, ji, 2) : te--);
            }
          }
        }, Dt = (u, p, g, S, b = null) => {
          const { el: x, type: M, transition: O, children: A, shapeFlag: $ } = u;
          if ($ & 6) {
            Dt(u.component.subTree, p, g, S);
            return;
          }
          if ($ & 128) {
            u.suspense.move(p, g, S);
            return;
          }
          if ($ & 64) {
            M.move(u, p, g, rn);
          ...
          if (M === ie) {
            o(x, p, g);
            for (let I = 0; I < A.length; I++) Dt(A[I], p, g, S);
            o(u.anchor, p, g);
            return;
          }
          if (M === Jn) {
          ...
          if (S !== 2 && $ & 1 && O) if (S === 0) O.beforeEnter(x), o(x, p, g), De(() => O.enter(x), b);
          else {
            const { leave: I, delayLeave: L, afterLeave: q } = O, Y = () => {
              u.ctx.isUnmounted ? i(x) : o(x, p, g);
            }, re = () => {
              I(x, () => {
                Y(), q && q();
              });
        ...
        }, Xe = (u, p, g, S = false, b = false) => {
          const { type: x, props: M, ref: O, children: A, dynamicChildren: $, shapeFlag: k, patchFlag: I, dirs: L, cacheIndex: q } = u;
          if (I === -2 && (b = false), O != null && (mt(), co(O, null, g, u, true), wt()), q != null && (p.renderCache[q] = void 0), k & 256) {
            p.ctx.deactivate(u);
            return;
          }
          const Y = k & 1 && L, re = !Jt(u);
          let te;
          if (re && (te = M && M.onVnodeBeforeUnmount) && et(te, p, u), k & 6) El(u.component, g, S);
          else {
            if (k & 128) {
              u.suspense.unmount(g, S);
              return;
            }
            Y && Lt(u, null, p, "beforeUnmount"), k & 64 ? u.type.remove(u, p, g, rn, S) : $ && !$.hasOnce && (x !== ie || I > 0 && I & 64) ? sn($, p, g, false, true) : (x === ie && I & 384 || !b && k & 16) && sn(A, p, g), S && Fi(u);
          }
          (re && (te = M && M.onVnodeUnmounted) || Y) && De(() => {
            te && et(te, p, u), Y && Lt(u, null, p, "unmounted");
          }, g);
        }, Fi = (u) => {
          const { type: p, el: g, anchor: S, transition: b } = u;
          if (p === ie) {
            Al(g, S);
            return;
          }
          ...
          if (u.shapeFlag & 1 && b && !b.persisted) {
            const { leave: M, delayLeave: O } = b, A = () => M(g, x);
            O ? O(u.el, x, A) : A();
          } else x();
        }, Al = (u, p) => {
          let g;
          for (; u !== p; ) g = h(u), i(u), u = g;
          i(p);
        }, El = (u, p, g) => {
          const { bum: S, scope: b, job: x, subTree: M, um: O, m: A, a: $, parent: k, slots: { __: I } } = u;
          es(A), es($), S && Yn(S), k && z(I) && I.forEach((L) => {
            k.renderCache[L] = void 0;
          }), b.stop(), x && (x.flags |= 8, Xe(M, u, p, g)), O && De(O, p), De(() => {
            u.isUnmounted = true;
          }, p), p && p.pendingBranch && !p.isUnmounted && u.asyncDep && !u.asyncResolved && u.suspenseId === p.pendingId && (p.deps--, p.deps === 0 && p.resolve());
        }, sn = (u, p, g, S = false, b = false, x = 0) => {
          for (let M = x; M < u.length; M++) Xe(u[M], p, g, S, b);
        }, jn = (u) => {
          if (u.shapeFlag & 6) return jn(u.component.subTree);
          if (u.shapeFlag & 128) return u.suspense.next();
          const p = h(u.anchor || u.el), g = p && p[Ea];
          return g ? h(g) : p;
        };
        let Bo = false;
        const zi = (u, p, g) => {
          u == null ? p._vnode && Xe(p._vnode, null, null, true) : v(p._vnode || null, u, p, null, null, null, g), p._vnode = u, Bo || (Bo = true, Ki(), wr(), Bo = false);
        }, rn = {
          p: v,
          um: Xe,
          m: Dt,
      ...
      function Hr(e, t, n = false) {
        ...
        if (z(o) && z(i)) for (let s = 0; s < o.length; s++) {
          const r = o[s];
          let l = i[s];
      ...
      function zr(e, t, n = oe) {
        ...
        const h = xa(e, t, l);
        return An && (f ? f.push(h) : a && h()), h;
      }
      function dc(e, t, n) {
        const o = this.proxy, i = fe(e) ? e.includes(".") ? Br(o, e) : () => o[e] : e.bind(o, o);
        let s;
      ...
      function hc(e, t, ...n) {
        ...
        r && (r.trim && (i = n.map((c) => fe(c) ? c.trim() : c)), r.number && (i = n.map(oo)));
      ...
      function jr(e, t, n = false) {
        ...
        return !s && !l ? (ae(e) && o.set(e, null), null) : (z(s) ? s.forEach((a) => r[a] = null) : Se(r, s), ae(e) && o.set(e, r), r);
      }
      function Oo(e, t) {
        return !e || !bo(t) ? false : (t = t.slice(2).replace(/Once$/, ""), ee(e, t[0].toLowerCase() + t.slice(1)) || ee(e, Nt(t)) || ee(e, t));
      }
      function ts(e) {
        const { type: t, vnode: n, proxy: o, withProxy: i, propsOptions: [s], slots: r, attrs: l, emit: a, render: f, renderCache: c, props: d, data: h, setupState: _, ctx: w, inheritAttrs: v } = e, m = ao(e);
        let P, C;
        try {
          if (n.shapeFlag & 4) {
            const y = i || o, R = y;
            P = nt(f.call(R, y, c, d, _, h, w)), C = l;
          } else {
            const y = t;
            P = nt(y.length > 1 ? y(d, {
              attrs: l,
        ...
        return n.dirs && (D = tn(D, null, false, true), D.dirs = D.dirs ? D.dirs.concat(n.dirs) : n.dirs), n.transition && Oi(D, n.transition), P = D, ao(m), P;
      }
      const _c = (e) => {
        let t;
      ...
      function mc(e, t, n) {
        const { props: o, children: i, component: s } = e, { props: r, children: l, patchFlag: a } = t, f = s.emitsOptions;
        if (t.dirs || t.transition) return true;
        if (n && a >= 0) {
          if (a & 1024) return true;
          if (a & 16) return o ? ns(o, r, f) : !!r;
          if (a & 8) {
            const c = t.dynamicProps;
            for (let d = 0; d < c.length; d++) {
              const h = c[d];
              if (r[h] !== o[h] && !Oo(f, h)) return true;
            }
          }
        } else return (i || l) && (!l || !l.$stable) ? true : o === r ? false : o ? r ? ns(o, r, f) : true : !!r;
        return false;
      }
      function ns(e, t, n) {
      ...
      const Ur = ({ key: e }) => e ?? null, Qn = ({ ref: e, ref_key: t, ref_for: n }) => (typeof e == "number" && (e = "" + e), e != null ? fe(e) || ve(e) || W(e) ? {
        i: we,
        r: e,
        k: t,
        f: !!n
      } : e : null);
      function E(e, t = null, n = null, o = 0, i = null, s = e === ie ? 0 : 1, r = false, l = false) {
        const a = {
          __v_isVNode: true,
          __v_skip: true,
          type: e,
        ...
        return l ? (Ii(a, n), s & 128 && e.normalize(a)) : n && (a.shapeFlag |= fe(n) ? 8 : 16), Cn > 0 && !r && Le && (a.patchFlag > 0 || s & 6) && a.patchFlag !== 32 && Le.push(a), a;
      }
      const pe = yc;
      function yc(e, t = null, n = null, o = 0, i = null, s = false) {
        ...
        if (Rc(e) && (e = e.__vccOpts), t) {
          ...
          l && !fe(l) && (t.class = Ve(l)), ae(a) && (Pi(a) && !z(a) && (a = Se({}, a)), t.style = Pt(a));
        }
        const r = fe(e) ? 1 : qr(e) ? 128 : Oa(e) ? 64 : ae(e) ? 4 : W(e) ? 2 : 0;
        return E(e, t, n, o, i, r, s, true);
      }
      function Wr(e) {
        return e ? Pi(e) || Mr(e) ? Se({}, e) : e : null;
      }
      function tn(e, t, n = false, o = false) {
        const { props: i, ref: s, patchFlag: r, children: l, transition: a } = e, f = t ? Ni(i || {}, t) : i, c = {
          __v_isVNode: true,
          __v_skip: true,
          type: e.type,
          props: f,
          key: f && Ur(f),
          ref: t && t.ref ? n && s ? z(s) ? s.concat(Qn(t)) : [
            s,
            Qn(t)
          ] : Qn(t) : s,
          scopeId: e.scopeId,
      ...
      function nt(e) {
        return e == null || typeof e == "boolean" ? pe(vt) : z(e) ? pe(ie, null, e.slice()) : Pn(e) ? $t(e) : pe(Ro, null, String(e));
      }
      function $t(e) {
      ...
      function Ni(...e) {
        ...
        for (let n = 0; n < e.length; n++) {
          ...
          for (const i in o) if (i === "class") t.class !== o.class && (t.class = Ve([
            ...
            const s = t[i], r = o[i];
            r && s !== r && !(z(s) && s.includes(r)) && (t[i] = s ? [].concat(s, r) : r);
          } else i !== "" && (t[i] = o[i]);
        }
        return t;
      }
      ...
      function Mc(e, t, n) {
        ...
        return o === 2 ? ae(t) && !z(t) ? Pn(t) ? pe(e, null, [
          t
      ...
      function Bc(e, t, n) {
        ...
        let s = false;
        if (n && !i) {
          if (t) if (fe(t)) for (const r of t.split(";")) {
      ...
      const _s = (e) => e.charCodeAt(0) === 111 && e.charCodeAt(1) === 110 && e.charCodeAt(2) > 96 && e.charCodeAt(2) < 123, Xc = (e, t, n, o, i, s) => {
        const r = i === "svg";
        t === "class" ? Hc(e, o, r) : t === "style" ? Bc(e, n, o) : bo(t) ? mi(t) || Vc(e, t, n, o, s) : (t[0] === "." ? (t = t.slice(1), true) : t[0] === "^" ? (t = t.slice(1), false) : Jc(e, t, o, r)) ? (ds(e, t, o), !e.tagName.includes("-") && (t === "value" || t === "checked" || t === "selected") && fs(e, t, o, r, s, t !== "value")) : e._isVueCE && (/[A-Z]/.test(t) || !fe(o)) ? ds(e, je(t), o, s, t) : (t === "true-value" ? e._trueValue = o : t === "false-value" && (e._falseValue = o), fs(e, t, o, r));
      };
      function Jc(e, t, n, o) {
        ...
        return _s(t) && fe(n) ? false : t in e;
      }
      const nn = (e) => {
        const t = e.props["onUpdate:modelValue"] || false;
        return z(t) ? (n) => Yn(t, n) : t;
      };
      function Qc(e) {
      ...
      const iu = Hn({
        ...
        setup(e, { emit: t }) {
          const n = e, o = t, i = ue(false), s = ue(50), r = ue(false), l = ue(0), a = ue(), f = ke({
            get() {
              return n.percent ?? s.value;
            },
            set(j) {
              o("update:percent", j), s.value = j;
            }
          });
          f.value = Number(n.initialPercent);
          const c = ke(() => n.isHorizontal ? "top-pane" : "left-pane"), d = ke(() => n.isHorizontal ? "bottom-pane" : "right-pane"), h = ke(() => n.isHorizontal ? `${f.value}% auto 1fr / none` : `none / ${f.value}% auto 1fr`), _ = ke(() => i.value ? "none" : "auto");
          function w() {
            r.value || o("splitter-click");
          }
          function v(j) {
            l.value = n.isHorizontal ? j.offsetY : j.offsetX, P();
          }
          function m() {
            l.value = 0, P();
          }
          ...
          function D(j) {
            i.value && R(j.touches[0]);
          }
          function y(j) {
            j.buttons && j.buttons === 0 && (i.value = false, F()), i.value && R(j);
          }
          function R(j) {
            let ne = l.value, U = a.value, se = 0;
            if (n.isHorizontal) {
              for (ne += U.offsetTop; U.offsetParent; ) U = U.offsetParent, ne += U.offsetTop;
              se = Math.floor((j.pageY - ne) / a.value.offsetHeight * 1e4) / 100;
            } else {
              for (ne += U.offsetLeft; U.offsetParent; ) U = U.offsetParent, ne += U.offsetLeft;
              se = Math.floor((j.pageX - ne) / a.value.offsetWidth * 1e4) / 100;
            }
            se > 0 && se < 100 && (f.value = se, r.value = true);
          }
          function J() {
            i.value = false, F();
          }
          ...
          return (j, ne) => (N(), H("div", {
            ...
            class: Ve([
              "vue-splitter",
              {
                horizontal: j.isHorizontal,
                vertical: !j.isHorizontal
              }
            ]),
            ...
            E("div", {
              ...
              ht(j.$slots, "right-pane"),
              ht(j.$slots, "bottom-pane")
            ], 2)
          ], 6));
        }
      }), su = {
            ...
            return N(), H(ie, null, [
              ...
              E("div", null, [
                Q(E("input", {
                  type: "text",
                  size: "4",
                  onKeyup: l[0] || (l[0] = Qr((f) => i(e.cfg, e.item.id, o.value), [
                    "enter"
                  ])),
                  "onUpdate:modelValue": l[1] || (l[1] = (f) => o.value = f)
                }, null, 544), [
                  [
                    ho,
                    o.value
                ...
                Q((N(), H("button", {
                  onClick: l[2] || (l[2] = (f) => i(e.cfg, e.item.id, o.value))
                }, l[4] || (l[4] = [
                  Pe("Requirement")
                ]))), [
                  [
      ...
      const Io = (e, t) => {
        ...
        setup(e, { emit: t }) {
          ...
          const f = ke(() => e.cfg.factories_for_process(o.value.process.id)), c = ue(null), d = ue(null), h = ke({
            get() {
              return console.log("factory_id 1", c.value, d.value, o.value.process.display, o.value.factory.id, f.value), (c.value == null || o.value.process.id != d.value) && (o.value.factory.id != null ? c.value = o.value.factory.id : f.value.length > 0 && (c.value = f.value[0].id)), d.value = o.value.process.id, console.log("factory_id 2", c.value, d.value, o.value.factory.id, f.value), c.value;
            },
            set(v) {
              console.log("factory_id change 1", v, c.value, i.value.id, f.value, e.cfg.factories_for_process(i.value.id)), c.value = v, n("modifier_update", o.value.process.id, v, Number(r.value.duration), Number(r.value.input), Number(r.value.output)), console.log("factory_id change 2", v, c.value, i.value.id, f.value, e.cfg.factories_for_process(i.value.id));
            }
          }), _ = ue(false);
          function w(v) {
          ...
          return (v, m) => {
            ...
            return N(), H(ie, null, [
              ...
              E("div", null, Me(i.value.duration) + "s ", 1),
              E("div", gu, [
                (N(true), H(ie, null, At(o.value.process.inputs, (C) => (N(), H("div", mu, [
                  E("div", null, Me(C.quantity), 1),
                  Q((N(), H("div", null, [
              ...
              Q(E("div", Eu, [
                Q(E("select", {
                  ...
                  (N(true), H(ie, null, At(f.value, (C) => (N(), H("option", {
                    key: C.id,
                    value: C.id
        ...
        setup(e, { emit: t }) {
          ...
          function a(c) {
            ...
            return d.concat(h).concat(_).concat(w).sort((m, P) => m.display().localeCompare(P.display()));
          }
          function f(c, d) {
          ...
          return (c, d) => (N(), H("details", {
            ...
            E("div", Iu, [
              d[2] || (d[2] = E("h3", null, "Data Set", -1)),
              d[3] || (d[3] = E("hr", null, null, -1)),
              E("span", null, Me(e.cfg.get_current_data_set() ? e.cfg.get_current_data_set().description() : ""), 1),
              d[4] || (d[4] = E("br", null, null, -1)),
              d[5] || (d[5] = E("br", null, null, -1)),
              d[6] || (d[6] = E("h3", null, "Items", -1)),
              E("div", Nu, [
              ...
              d[7] || (d[7] = E("br", null, null, -1)),
              d[8] || (d[8] = E("br", null, null, -1)),
              d[9] || (d[9] = E("h3", null, "Processes", -1)),
      ...
      ]), zu = "/assets/proc_rs_bg-dfpgSN5D.wasm", Bu = async (e = {}, t) => {
        let n;
      ...
      let Wn = null;
      function eo() {
        return (Wn === null || Wn.byteLength === 0) && (Wn = new Uint8Array(T.memory.buffer)), Wn;
      }
      function Mt(e, t) {
      ...
      const bs = typeof FinalizationRegistry > "u" ? {
        ...
        T.__wbindgen_export_3.get(e.dtor)(e.a, e.b);
      });
      function Vu(e, t, n, o) {
        const i = {
          a: e,
          ...
          try {
            ...
            --i.cnt === 0 ? (T.__wbindgen_export_3.get(i.dtor)(l, i.b), bs.unregister(i)) : i.a = l;
          }
        };
...
${e.stack}` : o;
      ...
      function _e(e, t, n) {
        if (n === void 0) {
          ...
          return eo().subarray(a, a + l.length).set(l), de = l.length, a;
        }
      ...
      let Ut = null;
      function On() {
        return (Ut === null || Ut.buffer.detached === true || Ut.buffer.detached === void 0 && Ut.buffer !== T.memory.buffer) && (Ut = new DataView(T.memory.buffer)), Ut;
      }
      function V(e) {
        const t = T.__wbindgen_export_2.get(e);
        return T.__externref_table_dealloc(e), t;
      }
      function Ku(e, t) {
        e = e >>> 0;
        const n = On(), o = [];
        for (let i = e; i < e + 4 * t; i += 4) o.push(T.__wbindgen_export_2.get(n.getUint32(i, true)));
        return T.__externref_drop_slice(e, t), o;
      }
      function Gu() {
        const e = T.dataset_all();
        var t = Ku(e[0], e[1]).slice();
        return T.__wbindgen_free(e[0], e[1] * 4, 4), t;
      }
      function Yu(e, t, n) {
        T.closure725_externref_shim(e, t, n);
      }
      function Xu(e, t, n, o) {
        T.closure737_externref_shim(e, t, n, o);
      }
      const Ju = [
        "same-origin",
        "no-cors",
      ...
      } : new FinalizationRegistry((e) => T.__wbg_datasetconf_free(e >>> 0, 1));
      class Do {
        static __wrap(t) {
          t = t >>> 0;
        ...
        free() {
          ...
          T.__wbg_datasetconf_free(t, 0);
        }
        get style() {
          return T.__wbg_get_datasetconf_style(this.__wbg_ptr);
        }
        set style(t) {
          T.__wbg_set_datasetconf_style(this.__wbg_ptr, t);
        }
        id() {
          let t, n;
          try {
            const o = T.datasetconf_id(this.__wbg_ptr);
        ...
        description() {
          let t, n;
          try {
            const o = T.datasetconf_description(this.__wbg_ptr);
            return t = o[0], n = o[1], Mt(o[0], o[1]);
          } finally {
            T.__wbindgen_free(t, n, 1);
          }
      ...
      } : new FinalizationRegistry((e) => T.__wbg_graphconfiguration_free(e >>> 0, 1));
      class Qu {
        __destroy_into_raw() {
          const t = this.__wbg_ptr;
        ...
        free() {
          const t = this.__destroy_into_raw();
          T.__wbg_graphconfiguration_free(t, 0);
        }
        constructor() {
          const t = T.graphconfiguration_new();
          return this.__wbg_ptr = t >>> 0, xs.register(this, this.__wbg_ptr, this), this;
        }
        get_current_data_set() {
          const t = T.graphconfiguration_get_current_data_set(this.__wbg_ptr);
          return t === 0 ? void 0 : Do.__wrap(t);
        }
        can_render() {
          const t = T.graphconfiguration_can_render(this.__wbg_ptr);
          if (t[2]) throw V(t[1]);
          return V(t[0]);
        }
        add_requirement(t, n) {
          const o = _e(t, T.__wbindgen_malloc, T.__wbindgen_realloc), i = de, s = T.graphconfiguration_add_requirement(this.__wbg_ptr, o, i, n);
          if (s[2]) throw V(s[1]);
          return V(s[0]);
        }
        update_requirement(t, n) {
          const o = _e(t, T.__wbindgen_malloc, T.__wbindgen_realloc), i = de, s = T.graphconfiguration_update_requirement(this.__wbg_ptr, o, i, n);
          if (s[2]) throw V(s[1]);
          return V(s[0]);
        }
        remove_requirement(t) {
          const n = _e(t, T.__wbindgen_malloc, T.__wbindgen_realloc), o = de, i = T.graphconfiguration_remove_requirement(this.__wbg_ptr, n, o);
          if (i[2]) throw V(i[1]);
          return V(i[0]);
        }
        get_requirements() {
          const t = T.graphconfiguration_get_requirements(this.__wbg_ptr);
          if (t[2]) throw V(t[1]);
          return V(t[0]);
        }
        add_import_export(t) {
          const n = _e(t, T.__wbindgen_malloc, T.__wbindgen_realloc), o = de, i = T.graphconfiguration_add_import_export(this.__wbg_ptr, n, o);
          if (i[2]) throw V(i[1]);
          return V(i[0]);
        }
        remove_import_export(t) {
          const n = _e(t, T.__wbindgen_malloc, T.__wbindgen_realloc), o = de, i = T.graphconfiguration_remove_import_export(this.__wbg_ptr, n, o);
          if (i[2]) throw V(i[1]);
          return V(i[0]);
        }
        get_imports_exports() {
          const t = T.graphconfiguration_get_imports_exports(this.__wbg_ptr);
          if (t[2]) throw V(t[1]);
          return V(t[0]);
        }
        add_process(t, n, o, i, s) {
          const r = _e(t, T.__wbindgen_malloc, T.__wbindgen_realloc), l = de, a = _e(n, T.__wbindgen_malloc, T.__wbindgen_realloc), f = de, c = T.graphconfiguration_add_process(this.__wbg_ptr, r, l, a, f, o, i, s);
          if (c[2]) throw V(c[1]);
          return V(c[0]);
        }
        remove_process(t) {
          const n = _e(t, T.__wbindgen_malloc, T.__wbindgen_realloc), o = de, i = T.graphconfiguration_remove_process(this.__wbg_ptr, n, o);
          if (i[2]) throw V(i[1]);
          return V(i[0]);
        }
        update_modifiers(t, n, o, i, s) {
          const r = _e(t, T.__wbindgen_malloc, T.__wbindgen_realloc), l = de, a = _e(n, T.__wbindgen_malloc, T.__wbindgen_realloc), f = de, c = T.graphconfiguration_update_modifiers(this.__wbg_ptr, r, l, a, f, o, i, s);
          if (c[2]) throw V(c[1]);
          return V(c[0]);
        }
        get_processes() {
          const t = T.graphconfiguration_get_processes(this.__wbg_ptr);
          if (t[2]) throw V(t[1]);
          return V(t[0]);
        }
        factories_for_process(t) {
          const n = _e(t, T.__wbindgen_malloc, T.__wbindgen_realloc), o = de, i = T.graphconfiguration_factories_for_process(this.__wbg_ptr, n, o);
          if (i[2]) throw V(i[1]);
          return V(i[0]);
        }
        get_defaulted_items() {
          const t = T.graphconfiguration_get_defaulted_items(this.__wbg_ptr);
          if (t[2]) throw V(t[1]);
          return V(t[0]);
        }
        get_intermediate_items() {
          const t = T.graphconfiguration_get_intermediate_items(this.__wbg_ptr);
          if (t[2]) throw V(t[1]);
          return V(t[0]);
        }
        update_data_set(t) {
          const n = _e(t, T.__wbindgen_malloc, T.__wbindgen_realloc), o = de;
          return T.graphconfiguration_update_data_set(this.__wbg_ptr, n, o);
        }
        search_items(t) {
          const n = _e(t, T.__wbindgen_malloc, T.__wbindgen_realloc), o = de, i = T.graphconfiguration_search_items(this.__wbg_ptr, n, o);
          if (i[2]) throw V(i[1]);
          return V(i[0]);
        }
        search_processes(t) {
          const n = _e(t, T.__wbindgen_malloc, T.__wbindgen_realloc), o = de, i = T.graphconfiguration_search_processes(this.__wbg_ptr, n, o);
          if (i[2]) throw V(i[1]);
          return V(i[0]);
        }
        search_processes_by_output(t) {
          const n = _e(t, T.__wbindgen_malloc, T.__wbindgen_realloc), o = de, i = T.graphconfiguration_search_processes_by_output(this.__wbg_ptr, n, o);
          if (i[2]) throw V(i[1]);
          return V(i[0]);
        }
        search_processes_by_input(t) {
          const n = _e(t, T.__wbindgen_malloc, T.__wbindgen_realloc), o = de, i = T.graphconfiguration_search_processes_by_input(this.__wbg_ptr, n, o);
          if (i[2]) throw V(i[1]);
          return V(i[0]);
        }
        calculate() {
          T.graphconfiguration_calculate(this.__wbg_ptr);
        }
        to_digraph() {
          const t = T.graphconfiguration_to_digraph(this.__wbg_ptr);
          if (t[2]) throw V(t[1]);
          return V(t[0]);
        }
        get_initial_matrix() {
          const t = T.graphconfiguration_get_initial_matrix(this.__wbg_ptr);
          if (t[2]) throw V(t[1]);
          return V(t[0]);
        }
        get_reduced_matrix() {
          const t = T.graphconfiguration_get_reduced_matrix(this.__wbg_ptr);
          if (t[2]) throw V(t[1]);
          return V(t[0]);
        }
      }
      typeof FinalizationRegistry > "u" || new FinalizationRegistry((e) => T.__wbg_versioned_free(e >>> 0, 1));
      function Zu() {
      ...
      function Af(e, t, n) {
        return Vu(e, t, 726, Yu);
      }
      function Ef(e, t) {
        const n = ui(t), o = _e(n, T.__wbindgen_malloc, T.__wbindgen_realloc), i = de;
        On().setInt32(e + 4 * 1, i, true), On().setInt32(e + 4 * 0, o, true);
      }
      function Of() {
        const e = T.__wbindgen_export_2, t = e.grow(4);
      ...
      function Nf(e, t) {
        ...
        var i = Bn(o) ? 0 : _e(o, T.__wbindgen_malloc, T.__wbindgen_realloc), s = de;
      ...
      const B = await Bu({
        "./proc_rs_bg.js": {
          ...
          __wbindgen_throw: Lf,
          __wbindgen_closure_wrapper2842: Af,
          __wbindgen_init_externref_table: Of
        }
      }, zu), kf = B.memory, Hf = B.__wbg_datasetconf_free, Ff = B.__wbg_get_datasetconf_style, zf = B.__wbg_set_datasetconf_style, Bf = B.datasetconf_id, jf = B.datasetconf_description, qf = B.__wbg_versioned_free, Vf = B.stuff, Uf = B.dataset_all, Wf = B.__wbg_graphconfiguration_free, Kf = B.graphconfiguration_new, Gf = B.graphconfiguration_get_current_data_set, Yf = B.graphconfiguration_can_render, Xf = B.graphconfiguration_add_requirement, Jf = B.graphconfiguration_update_requirement, Qf = B.graphconfiguration_remove_requirement, Zf = B.graphconfiguration_get_requirements, ed = B.graphconfiguration_add_import_export, td = B.graphconfiguration_remove_import_export, nd = B.graphconfiguration_get_imports_exports, od = B.graphconfiguration_add_process, id = B.graphconfiguration_remove_process, sd = B.graphconfiguration_update_modifiers, rd = B.graphconfiguration_get_processes, ld = B.graphconfiguration_factories_for_process, ad = B.graphconfiguration_get_defaulted_items, cd = B.graphconfiguration_get_intermediate_items, ud = B.graphconfiguration_update_data_set, fd = B.graphconfiguration_search_items, dd = B.graphconfiguration_search_processes, pd = B.graphconfiguration_search_processes_by_output, hd = B.graphconfiguration_search_processes_by_input, _d = B.graphconfiguration_calculate, gd = B.graphconfiguration_to_digraph, md = B.graphconfiguration_get_initial_matrix, wd = B.graphconfiguration_get_reduced_matrix, vd = B.__wbindgen_exn_store, bd = B.__externref_table_alloc, yd = B.__wbindgen_export_2, xd = B.__wbindgen_export_3, Sd = B.__wbindgen_malloc, $d = B.__wbindgen_realloc, Td = B.__wbindgen_free, Cd = B.__externref_table_dealloc, Pd = B.__externref_drop_slice, Ad = B.closure725_externref_shim, Ed = B.closure737_externref_shim, nl = B.__wbindgen_start, Od = Object.freeze(Object.defineProperty({
        __proto__: null,
        __externref_drop_slice: Pd,
        __externref_table_alloc: bd,
        __externref_table_dealloc: Cd,
        __wbg_datasetconf_free: Hf,
        __wbg_get_datasetconf_style: Ff,
        __wbg_graphconfiguration_free: Wf,
        __wbg_set_datasetconf_style: zf,
        __wbg_versioned_free: qf,
        __wbindgen_exn_store: vd,
        __wbindgen_export_2: yd,
        __wbindgen_export_3: xd,
        __wbindgen_free: Td,
        __wbindgen_malloc: Sd,
        __wbindgen_realloc: $d,
        __wbindgen_start: nl,
        closure725_externref_shim: Ad,
        closure737_externref_shim: Ed,
        dataset_all: Uf,
        datasetconf_description: jf,
        datasetconf_id: Bf,
        graphconfiguration_add_import_export: ed,
        graphconfiguration_add_process: od,
        graphconfiguration_add_requirement: Xf,
        graphconfiguration_calculate: _d,
        graphconfiguration_can_render: Yf,
        graphconfiguration_factories_for_process: ld,
        graphconfiguration_get_current_data_set: Gf,
        graphconfiguration_get_defaulted_items: ad,
        graphconfiguration_get_imports_exports: nd,
        graphconfiguration_get_initial_matrix: md,
        graphconfiguration_get_intermediate_items: cd,
        graphconfiguration_get_processes: rd,
        graphconfiguration_get_reduced_matrix: wd,
        graphconfiguration_get_requirements: Zf,
        graphconfiguration_new: Kf,
        graphconfiguration_remove_import_export: td,
        graphconfiguration_remove_process: id,
        graphconfiguration_remove_requirement: Qf,
        graphconfiguration_search_items: fd,
        graphconfiguration_search_processes: dd,
        graphconfiguration_search_processes_by_input: hd,
        graphconfiguration_search_processes_by_output: pd,
        graphconfiguration_to_digraph: gd,
        graphconfiguration_update_data_set: ud,
        graphconfiguration_update_modifiers: sd,
        graphconfiguration_update_requirement: Jf,
        memory: kf,
        stuff: Vf
      }, Symbol.toStringTag, {
        value: "Module"
      ...
      const Rd = [
        ...
        setup(e, { emit: t }) {
          ...
          function C(y, R, J, F) {
            console.log("adding process", R, F, y), _.value = "", w.value = [];
            let j = y.add_process(R, J, F.duration, F.input, F.output);
            console.log("add process result", j, y, y.get_processes()), n("fold_update", "search-results", false), n("cfg_update");
          }
          function D(y, R) {
            n("fold_update", y, R);
          }
          return (y, R) => {
            ...
            return N(), H(ie, null, [
              E("details", {
                ...
                onToggle: R[3] || (R[3] = (F) => n("fold_update", F, null))
              }, [
                R[9] || (R[9] = E("summary", {
                  class: "header"
                }, "Get Started", -1)),
                E("div", Md, [
                  ...
                  Q((N(), H("div", null, [
                    Q(E("select", {
                      ...
                      (N(true), H(ie, null, At(Ce(f), (F) => (N(), H("option", {
                        value: F.id()
                      }, Me(F.description()), 9, Id))), 256))
                    ], 512), [
                      [
                        Jr,
                        c.value
                  ...
                  Q((N(), H("div", null, [
                    Q(E("input", {
                      ...
                      type: "text",
                      disabled: c.value == "",
                      "onUpdate:modelValue": R[2] || (R[2] = (F) => _.value = F)
                    }, null, 8, Dd), [
                      [
                        ho,
                        _.value
              ...
              E("details", {
                ...
                onToggle: R[4] || (R[4] = (F) => n("fold_update", "search-results"))
              }, [
                R[10] || (R[10] = E("summary", {
                  class: "header"
                }, "Search Results", -1)),
                E("div", kd, [
                  (N(true), H(ie, null, At(h.value, (F) => (N(), Be(su, {
                    onCfg_update: v,
                    item: F,
                    cfg: Ce(r)
                  }, null, 8, [
                  ...
                  E("div", Hd, [
                    E("div", Fd, [
                      w.value.length > 0 ? (N(), H("hr", zd)) : ot("", true),
                      w.value.length > 0 ? (N(), H("div", Bd, "Duration")) : ot("", true),
                      w.value.length > 0 ? (N(), H("div", jd, "Inputs")) : ot("", true),
                      w.value.length > 0 ? (N(), H("div", qd, "Outputs")) : ot("", true),
                      w.value.length > 0 ? (N(), H("hr", Vd)) : ot("", true),
                      (N(true), H(ie, null, At(w.value, (F) => (N(), Be(el, {
                        proc: F,
                        cfg: Ce(r),
                        folds: Ce(a),
                        onFold_update: D,
                        ...
                        action_button: at(({ factory_id: j, modifiers: ne }) => [
                          E("button", {
                            onClick: (U) => C(Ce(r), F.id, j, ne)
                          }, "Add", 8, Ud)
                        ]),
                        _: 2
                      }, 1032, [
        ...
        setup(e) {
          ...
          function o() {
            console.log("A handle_cfg_update"), s("get-started", !t.value.can_render()), s("current-configuration", t.value.can_render()), _a(t), n.value++;
          }
          const i = ue({
          ...
          function s(r, l) {
            console.log("fold update 1", r, l, i.value, r);
            let a = null;
            r.target ? a = r.target.id : a = r, typeof l < "u" && l != null ? i.value[a] = l : i[a] = !i[a], console.log("fold update 2", a, l, i.value, r);
          }
          return (r, l) => (N(), H(ie, null, [
            l[0] || (l[0] = E("header", null, [
              E("h1", null, "Process Calculator")
            ], -1)),
            l[1] || (l[1] = E("br", null, null, -1)),
            E("main", null, [
              pe(Ce(iu), null, {
                "left-pane": at(() => [
                  pe(Kd, {
        ...
        "start",
        "end"
      ], $s = Jd.reduce((e, t) => e.concat(t, t + "-" + Ss[0], t + "-" + Ss[1]), []), Rn = Math.min, zt = Math.max, Qd = {
        left: "right",
        right: "left",
        bottom: "top",
        top: "bottom"
      ...
      function Ps(e, t, n) {
        ...
        const s = _t(t), r = Li(t), l = Di(r), a = ct(t), f = s === "y", c = o.x + o.width / 2 - i.width / 2, d = o.y + o.height / 2 - i.height / 2, h = o[l] / 2 - i[l] / 2;
        let _;
        switch (a) {
          case "top":
            _ = {
      ...
      const lp = async (e, t, n) => {
        ...
        let f = await r.getElementRects({
          ...
          floating: t,
          strategy: i
        }), { x: c, y: d } = Ps(f, o, a), h = o, _ = {}, w = 0;
        for (let v = 0; v < l.length; v++) {
          const { name: m, fn: P } = l[v], { x: C, y: D, data: y, reset: R } = await P({
            x: c,
            y: d,
            initialPlacement: o,
            placement: h,
          ...
          }, R && w <= 50 && (w++, typeof R == "object" && (R.placement && (h = R.placement), R.rects && (f = R.rects === true ? await r.getElementRects({
            reference: e,
            floating: t,
            strategy: i
          }) : R.rects), { x: c, y: d } = Ps(f, h, a)), v = -1);
        }
        return {
          x: c,
          y: d,
      ...
      async function Lo(e, t) {
        var n;
        t === void 0 && (t = {});
        const { x: o, y: i, platform: s, rects: r, elements: l, strategy: a } = e, { boundary: f = "clippingAncestors", rootBoundary: c = "viewport", elementContext: d = "floating", altBoundary: h = false, padding: _ = 0 } = jt(t, e), w = sl(_), m = l[h ? d === "floating" ? "reference" : "floating" : d], P = wn(await s.getClippingRect({
        ...
        return {
          top: (P.top - R.top + w.top) / y.y,
          bottom: (R.bottom - P.bottom + w.bottom) / y.y,
          left: (P.left - R.left + w.left) / y.x,
          right: (R.right - P.right + w.right) / y.x
        };
      }
      const ap = (e) => ({
        name: "arrow",
        options: e,
        async fn(t) {
          const { x: n, y: o, placement: i, rects: s, platform: r, elements: l, middlewareData: a } = t, { element: f, padding: c = 0 } = jt(e, t) || {};
          if (f == null) return {};
          const d = sl(c), h = {
            x: n,
            y: o
          }, _ = Li(i), w = Di(_), v = await r.getDimensions(f), m = _ === "y", P = m ? "top" : "left", C = m ? "bottom" : "right", D = m ? "clientHeight" : "clientWidth", y = s.reference[w] + s.reference[_] - h[_] - s.floating[w], R = h[_] - s.reference[_], J = await (r.getOffsetParent == null ? void 0 : r.getOffsetParent(f));
          let F = J ? J[D] : 0;
          (!F || !await (r.isElement == null ? void 0 : r.isElement(J))) && (F = l.floating[D] || s.floating[w]);
          const j = y / 2 - R / 2, ne = F / 2 - v[w] / 2 - 1, U = Rn(d[P], ne), se = Rn(d[C], ne), ge = U, $e = F - v[w] - se, he = F / 2 - v[w] / 2 + j, Ye = fi(ge, he, $e), ce = !a.arrow && We(i) != null && he !== Ye && s.reference[w] / 2 - (he < ge ? U : se) - v[w] / 2 < 0, G = ce ? he < ge ? he - ge : he - $e : 0;
          return {
            [_]: h[_] + G,
            data: {
              [_]: Ye,
      ...
      const up = function(e) {
        return e === void 0 && (e = {}), {
          ...
          async fn(t) {
            var n, o, i;
            const { rects: s, middlewareData: r, placement: l, platform: a, elements: f } = t, { crossAxis: c = false, alignment: d, allowedPlacements: h = $s, autoAlignment: _ = true, ...w } = jt(e, t), v = d !== void 0 || h === $s ? cp(d || null, _, h) : h, m = await Lo(t, w), P = ((n = r.autoPlacement) == null ? void 0 : n.index) || 0, C = v[P];
            if (C == null) return {};
            const D = il(C, s, await (a.isRTL == null ? void 0 : a.isRTL(f.floating)));
            if (l !== C) return {
              reset: {
                placement: v[0]
              }
            ...
            }).sort((U, se) => U[1] - se[1]), ne = ((i = F.filter((U) => U[2].slice(0, We(U[0]) ? 2 : 3).every((se) => se <= 0))[0]) == null ? void 0 : i[0]) || F[0][0];
            return ne !== l ? {
              data: {
                index: P + 1,
                overflows: R
        ...
        return e === void 0 && (e = {}), {
          ...
          async fn(t) {
            var n, o;
            const { placement: i, middlewareData: s, rects: r, initialPlacement: l, platform: a, elements: f } = t, { mainAxis: c = true, crossAxis: d = true, fallbackPlacements: h, fallbackStrategy: _ = "bestFit", fallbackAxisSideDirection: w = "none", flipAlignment: v = true, ...m } = jt(e, t);
            if ((n = s.arrow) != null && n.alignmentOffset) return {};
            const P = ct(i), C = _t(l), D = ct(l) === l, y = await (a.isRTL == null ? void 0 : a.isRTL(f.floating)), R = h || (D || !v ? [
              go(l)
            ] : tp(l)), J = w !== "none";
            !h && J && R.push(...sp(l, v, w, y));
            const F = [
              l,
              ...R
            ], j = await Lo(t, m), ne = [];
            ...
            if (U = [
              ...
              var se, ge;
              const he = (((se = s.flip) == null ? void 0 : se.index) || 0) + 1, Ye = F[he];
      ...
      async function pp(e, t) {
        const { placement: n, platform: o, elements: i } = e, s = await (o.isRTL == null ? void 0 : o.isRTL(i.floating)), r = ct(n), l = We(n), a = _t(n) === "y", f = dp.has(r) ? -1 : 1, c = s && a ? -1 : 1, d = jt(t, e);
      ...
      const hp = function(e) {
        return e === void 0 && (e = 0), {
          ...
          async fn(t) {
            var n, o;
            const { x: i, y: s, placement: r, middlewareData: l } = t, a = await pp(t, e);
        ...
        return e === void 0 && (e = {}), {
          ...
          async fn(t) {
            ...
            let _ = f[h], w = f[d];
            if (s) {
              const m = h === "y" ? "top" : "left", P = h === "y" ? "bottom" : "right", C = _ + c[m], D = _ - c[P];
              _ = fi(C, _, D);
            }
            if (r) {
              const m = d === "y" ? "top" : "left", P = d === "y" ? "bottom" : "right", C = w + c[m], D = w - c[P];
              w = fi(C, w, D);
            }
            const v = l.fn({
              ...t,
        ...
        return e === void 0 && (e = {}), {
          ...
          async fn(t) {
            ...
            }, ...f } = jt(e, t), c = await Lo(t, f), d = ct(i), h = We(i), _ = _t(i) === "y", { width: w, height: v } = s.floating;
            let m, P;
            d === "top" || d === "bottom" ? (m = d, P = h === (await (r.isRTL == null ? void 0 : r.isRTL(l.floating)) ? "start" : "end") ? "left" : "right") : (P = d, m = h === "end" ? "top" : "bottom");
            const C = v - c.top - c.bottom, D = w - c.left - c.right, y = Rn(v - c[m], C), R = Rn(w - c[P], D), J = !t.middlewareData.shift;
            let F = y, j = R;
            if ((n = t.middlewareData.shift) != null && n.enabled.x && (j = D), (o = t.middlewareData.shift) != null && o.enabled.y && (F = C), J && !h) {
              const U = zt(c.left, 0), se = zt(c.right, 0), ge = zt(c.top, 0), $e = zt(c.bottom, 0);
              _ ? j = w - 2 * (U !== 0 || se !== 0 ? U + se : zt(c.left, c.right)) : F = v - 2 * (ge !== 0 || $e !== 0 ? ge + $e : zt(c.top, c.bottom));
            }
            await a({
              ...t,
              availableWidth: j,
      ...
      function Mn(e, t, n, o) {
        ...
        const f = l ? Fe(l) : window, c = !cl() && n;
        let d = (r.left + (c && ((i = f.visualViewport) == null ? void 0 : i.offsetLeft) || 0)) / a.x, h = (r.top + (c && ((s = f.visualViewport) == null ? void 0 : s.offsetTop) || 0)) / a.y, _ = r.width / a.x, w = r.height / a.y;
        if (l) {
          const v = Fe(l), m = o && Et(o) ? Fe(o) : o;
          let P = v.frameElement;
          for (; P && o && m !== v; ) {
            const C = Zt(P), D = P.getBoundingClientRect(), y = getComputedStyle(P);
            D.x += (P.clientLeft + parseFloat(y.paddingLeft)) * C.x, D.y += (P.clientTop + parseFloat(y.paddingTop)) * C.y, d *= C.x, h *= C.y, _ *= C.x, w *= C.y, d += D.x, h += D.y, P = Fe(P).frameElement;
          }
        }
        return {
          width: _,
      ...
      function Os(e, t, n) {
        return t === "viewport" ? wn(function(o, i) {
          ...
          let a = r.clientWidth, f = r.clientHeight, c = 0, d = 0;
          if (l) {
          ...
          let f = -s.scrollLeft + dl(o);
          const c = -s.scrollTop;
          return st(r).direction === "rtl" && (f += vn(i.clientWidth, r.clientWidth) - l), {
            width: l,
            height: a,
            x: f,
            y: c
      ...
      function Ms(e) {
        const t = Fe(e);
        let n = Rs(e);
        for (; n && mp(n) && st(n).position === "static"; ) n = Rs(n);
      ...
      const vp = {
        getClippingRect: function(e) {
          ...
          const s = n === "clippingAncestors" ? function(f, c) {
            const d = c.get(f);
            if (d) return d;
            let h = wo(f).filter((m) => Et(m) && It(m) !== "body"), _ = null;
            const w = st(f).position === "fixed";
            let v = w ? In(f) : f;
            for (; Et(v) && !ki(v); ) {
              const m = st(v), P = di(v);
              (w ? P || _ : P || m.position !== "static" || !_ || ![
                "absolute",
                "fixed"
            ...
            const d = Os(t, c, i);
            return f.top = vn(d.top, f.top), f.right = As(d.right, f.right), f.bottom = As(d.bottom, f.bottom), f.left = vn(d.left, f.left), f;
          }, Os(t, l, i));
          return {
        ...
        convertOffsetParentRelativeRectToViewportRelativeRect: function(e) {
          ...
          if ((i || !i && o !== "fixed") && ((It(n) !== "body" || ko(s)) && (r = Ho(n)), rt(n))) {
            const f = Mn(n);
            l = Zt(n), a.x = f.x + n.clientLeft, a.y = f.y + n.clientTop;
          }
          return {
            width: t.width * l.x,
            height: t.height * l.y,
      ...
      const Zo = "__floating-vue__popper", ml = () => Hn({
        ...
        methods: {
          ...
          async $_computePosition() {
            ...
            (this.distance || this.skidding) && e.middleware.push(hp({
              mainAxis: this.distance,
              crossAxis: this.skidding
            }));
            const t = this.placement.startsWith("auto");
            if (t ? e.middleware.push(up({
              alignment: this.placement.split("-")[1] ?? ""
            })) : e.placement = this.placement, this.preventOverflow && (this.shift && e.middleware.push(_p({
              padding: this.overflowPadding,
              boundary: this.boundary,
              crossAxis: this.shiftCrossAxis
            })), !t && this.flip && e.middleware.push(fp({
              padding: this.overflowPadding,
              boundary: this.boundary
            }))), e.middleware.push(ap({
              ...
              e.middleware.push({
                ...
                fn: ({ rects: i, placement: s, middlewareData: r }) => {
                  ...
                  let a, f;
                  return s.startsWith("top") || s.startsWith("bottom") ? a = i.reference.width : f = i.reference.height, this.$_innerNode.style[o === "min" ? "minWidth" : o === "max" ? "maxWidth" : "width"] = a != null ? `${a}px` : null, this.$_innerNode.style[o === "min" ? "minHeight" : o === "max" ? "maxHeight" : "height"] = f != null ? `${f}px` : null, {
                    data: {
                      skip: true
                    },
                    reset: {
            ...
            (this.autoMaxSize || this.autoBoundaryMaxSize) && (this.$_innerNode.style.maxWidth = null, this.$_innerNode.style.maxHeight = null, e.middleware.push(gp({
              boundary: this.boundary,
              padding: this.overflowPadding,
            ...
            const n = await bp(this.$_referenceNode, this.$_popperNode, e);
      ...
      function Bs(e, t, n) {
        return n.closeAllPopover || n.closePopover && t || xp(e, n) && !t;
      }
      function xp(e, t) {
      ...
      function Gn(e, t, n, o, i, s, r, l) {
        const a = ((r - i) * (t - s) - (l - s) * (e - i)) / ((l - s) * (n - e) - (r - i) * (o - t)), f = ((n - e) * (t - s) - (o - t) * (e - i)) / ((l - s) * (n - e) - (r - i) * (o - t));
      ...
      Pa();
      const Op = Ap((e, t, n, o, i, s) => (N(), Be("div", Ep)));
      zo.render = Op;
      ...
      function Fp(e, t, n, o, i, s) {
        ...
        return N(), Be(l, Ni({
          ...
          default: at(({ popperId: a, isShown: f, shouldMountContent: c, skipTransition: d, autoHide: h, show: _, hide: w, handleResize: v, onResize: m, classes: P, result: C }) => [
            ht(e.$slots, "default", {
              shown: f,
              show: _,
              hide: w
      ...
      function Wp(e, t, n, o, i, s) {
        ...
        return N(), Be(l, Ni({
          ...
          default: at(({ popperId: a, isShown: f, shouldMountContent: c, skipTransition: d, autoHide: h, hide: _, handleResize: w, onResize: v, classes: m, result: P }) => [
            pe(r, {
              ref: "popperContent",
              class: Ve({
      ...
      function Sl(e, t, n) {
        ...
        return i === "string" ? o = {
          ...
          content: false
        }, o.placement = Gp(o, n), o.targetNodes = () => [
          e
        ], o.referenceNode = () => e, o;
      }
      let ei, Dn, Yp = 0;
      function Xp() {
        ...
        Dn = ue([]), ei = Zr({
          ...
          render() {
            return this.directives.map((t) => Mc(Kp, {
              ...t.options,
      ...
      function js(e, { value: t, modifiers: n }) {
        ...
        if (!o.content || Nn(o.theme || "tooltip", "disabled")) $l(e);
          ...
          let i;
          e.$_popper ? (i = e.$_popper, i.options.value = o) : i = Jp(e, t, n), typeof t.shown < "u" && t.shown !== e.$_popperOldShown && (e.$_popperOldShown = t.shown, t.shown ? i.show() : i.hide());
        }
      }
      const Qp = {
        beforeMount: js,
      ...
      function eh(e, t = {}) {
        e.$_vTooltipInstalled || (e.$_vTooltipInstalled = true, hl(Ke, t), e.directive("tooltip", Qp), e.directive("close-popper", Zp), e.component("VTooltip", jp), e.component("VDropdown", zp), e.component("VMenu", Bp));
      }
      const th = {
        version: "5.2.2",
        install: eh,
